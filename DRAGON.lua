...
if res ~= 200 then
print('\27[0;31mٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/Bandaa2/soon/main/File_Bot/commands.lua") 
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'سون'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "s_o_op")
...
os.execute('wget https://raw.githubusercontent.com/Bandaa2/soon/main/DRAGON.lua')
send(msg.chat_id_, msg.id_,' ✯ تم تحديث السورس \n ✯ لديك اخر اصدار لسورس سون\n ✯ الاصدار » { v 1.5}')
dofile('DRAGON.lua')  
end
if text == 'الاصدار ' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✯ اصدار سورس سون \n ✯ الاصدار »{ v 1.5}')
end
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/s_o_op"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[TWL](t.me/uu_ban25BOT)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/uu_ban25BOT"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 's_o_op')..') \n ✯ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ✯ العضو : {["..data.first_name_.."](T.ME/s_o_op)}\n ✯ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ✯ عذرا » {["..data.first_name_.."](T.ME/s_o_op)}\n ✯ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
🕸️W𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 𝒔𝒐𝒐𝒐𝒏🕸️
🕸️مرحب بيك في سورس سون الاعظم🕸️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩B𝗮ꪀ𝗱A𓆪',url="t.me/uu_ban"}},
{{text = '𓆩𝙨𝙤𝙪𝙧𝙘𝙚𓆪', url="t.me/s_o_op"}},
{{text = '𓆩𝗧𝘄𝗮𝘀𝗼𝗹𓆪', url="t.me/uu_ban25BOT"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local Text = [[
W𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒕𝒉𝒆 𝒔𝒐𝒐𝒐𝒏🕸️
🕸️اهلا بك في سورس سون الجمدان لو عايز بوت بأسعار منسبه وبوت مميز كلمني 🕸️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𓆩B𝗮ꪀ𝗱A𓆪',url="t.me/uu_ban"}},
...
if text == 'بار باندا' or text == '@UU_Le4' or text == 'متيجي' then
local Text = [[
🕸️تع يقلب انضم لبار باندا 🕸️
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'بار باندا يقلب',url="t.me/UU_Le4"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ✯ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 's_o_op')..') \n ✯ تـم قفـل التاك بالكتم ')
end,nil)   
...
send(msg.chat_id_, msg.id_, " 🕸️ لا يمكنك حظر المبرمج باندا\n")
return false 
end
...
function(arg,data) 
usertext = '\n 🕸️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🕸️ تم حظره عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
usertext = '\n 🕸️ العضو » ['..result.title_..'](t.me/'..(username or 's_o_op')..')'
status  = '\n 🕸️ تم حظره عام من الكروبات'
texts = usertext..status
...
if result.sender_user_id_ == tonumber(1366055467) then
send(msg.chat_id_, msg.id_, " 🕸️ لا يمكنك كتم المبرمج باندا\n")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
...
usertext = '\n 🕸️ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n 🕸️ تم الغاء (الحظر-الكتم) عام من الكروبات'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Bandaa2/soon/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ✯ اهلا بك في متجر ملفات السنافر \n ✯ ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴ\n ✯ علامة تعني { ✔️ } ملف مفعل\n ✯ علامة تعني { ✖ } ملف معطل\n ✯ قناة سورس سون ↓\n".." ✯ [اضغط هنا لدخول](t.me/s_o_op) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/Bandaa2/soon/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ✯ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
status  = '\n ✯ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ✯ العضو » '..userid..''
...
send(msg.chat_id_, msg.id_, ' ✯ تم تنزيل جميع ال لقلبي بالجروب')
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ✯ العضو » ['..result.title_..'](t.me/'..(text1[3] or 's_o_op')..')'..'\n ✯ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
database:set(bot_id.."s_o_op:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."s_o_op:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."s_o_op:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."s_o_op:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"✯تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."s_o_op:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."s_o_op:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سون يعني لو بكتهن راح اعرفك انت الاخذتهن
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝗌𝗈𝗎𝗋𝖼𝖾 𝗌𝗈𝗈𝗇 ', url="t.me/s_o_op"},
...
send(msg.chat_id_, msg.id_, t..'ٴ≪┉ ┉ ┉ ┉ ┉ 𝙨𝙤𝙤𝙣 ┉  ┉ ┉ ┉ ┉≫ٴٴ\n✯ [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒔𝒐𝒐𝒐𝒏 ](t.me/s_o_op)')
end
